...
\todo[inline]{Invloed aantal nodes?}
...
\todo[inline]{Het bandbreedtepatroon van GETNEXT vs GETBULK verschilt grondig. \\
Bij bulk zijn de antwoordpakketten veel groter dan de verzonden pakketten. \\
Bij getnext zijn ze ongeveer gelijk, getbulk bespaart dus bandbreedte (minder overhead van alle headers van de overbodige pakketten) \\
Bps == packets/sec}
...
\end{figure}
\todo[inline]{decimalen in uitvoeringstijd weglaten}
...
\end{figure}
\todo[inline]{Relatief tijdstip ~> Uitvoeringstijd}
...
\todo[inline]{SNMP bulkwalk is zowel sneller als efficienter voor wat betreft dataverbruik en nodige bandbreedte.}
