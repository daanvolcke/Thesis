...
We doen een walk van 2 \glspl{oid} op een enkele productieswitch: ip (1.3.6.1.2.1.4) en dot1dBase (1.3.6.1.2.1.17.1).
...
SNMP Walk met GETBULK-requests                                                              & 441      & 3,131               & 0,141       \\
\begin{tabular}[c]{@{}l@{}}RetrieveFromDevice methode met\\   GETNEXT-requests\end{tabular} & 472      & 5,060               & 0,093       \\
\begin{tabular}[c]{@{}l@{}}RetrieveFromDevice methode met\\   GETBULK-requests\end{tabular} & 441      & 0,722               & 0,611       \\ \bottomrule
\end{tabular}
...
De requests zijn nu nog maar voor 11\% i.p.v. 58\% verantwoordelijk van de totale uitvoeringstijd.
