...
Hierbij werd de \emph{Main} methode opengeklapt.\todo{Koppelteken}
...
We beginnen met de methode die het meeste tijd in beslag neemt: de \emph{RetrieveFromDevice} methode. \todo{Koppelteken}
