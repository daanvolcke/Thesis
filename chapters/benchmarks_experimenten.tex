...
Indien nodig twee paragrafen over bulkrequests:

\begin{itemize}
	\item We zijn begonnen met GET- vs. BULK te testen met Net-SNMP tools alvorens te implementeren!
	\item Over de impact van latency? (Niet getest...)
	\item Over het aantal objecten dat we best in een request stoppen
\end{itemize}
