...
Als je te maken hebt met een latency van zeg maar 25 ms, wil dat zeggen dat je steeds 25 ms moet wachten alvorens je de volgende request kunt sturen.
...
Jammer genoeg wordt er per seconde maar een meting van het CPU-gebruik gedaan, waardoor
...
We bekijken hoeveel objecten die \glspl{oid} ons opleveren en vergelijken we dit met het totaal aantal objecten dat een \gls{snmp-agent} aanbiedt.
...
Anderzijds bevatten de virtuele machines heel wat extra informatie die een gewone switch niet heeft, omdat ze een compleet besturingssysteem draaien.
...
Eén gegeven per keer in de databank wegschrijven klinkt even inefficiënt als het ophalen van een gegeven per keer.
...
Mocht er toch iets toegevoegd dienen te worden, worden beschik je over de broncode om dit gemakkelijk zelf te kunnen doen.
