...
gegevens kan opvragen. De originele versie van de SNMP Data Retriever maakte gebruik van
...
Gemiddeld deed een request er een kleine 10 milliseconden over, samen goed voor bijna 60\% (oftewel ... seconden) van de totale uitvoeringstijd. \todo{aanvullen}
