...
\usepackage{graphicx}
% All kinds of references become clickable hyperlinks in PDF.
\usepackage{hyperref}
...
% Testopstelling
%TODO: DELETE ME
\include{chapters/testopstelling}

% Meetresultaten/oplossingen
%TODO: DELETE ME
\include{chapters/meetresultaten}

% Tekstfragmenten
\include{chapters/tekstfragmenten}
